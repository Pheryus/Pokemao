...
namespace Map
{
    public static class MapGenerator
    {
        ...
        { NodeType.ChaosEnemy, NodeType.EarthEnemy, NodeType.FireEnemy, NodeType.IceEnemy,
            NodeType.NatureEnemy, NodeType.ThunderEnemy, NodeType.WaterEnemy, NodeType.WindEnemy, NodeType.NeutralEnemy};

        private static readonly List<NodeType> GoodNodes = new List<NodeType> {
            NodeType.RestSite, NodeType.Store
        };
        ...
        private static void PlaceLayer(int layerIndex)
        {
            ...
            {
                var nodeType = NodeType.Mystery;

                if (layer.nodeType == NodeType.Store) {
                    nodeType = Random.Range(0f, 1f) < layer.randomizeNodes ? GetRandomRewardNode() : layer.nodeType;
                }
                else {
        ...
        private static NodeType GetRandomRewardNode() {
